 ...
 * @subpackage WP_Preloader_unlimited/public
 */
 ...
 */
class WP_Preloader_unlimited_Public {
	...
	public function wppu_wp_latest_jquery() {
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'css/wppu-public.css', array(), $this->version, 'all' );
